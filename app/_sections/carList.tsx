...
const CarList = () => {
  return (
    ...
    >
        ...
        {Array.from({ length: 5 }).map((_, index) => (
          <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
            ...
            <div className='text-black flex'>
                ...
                <p className='text-2xl font-semibold text-red-700'>40.399,00</p>
            <p/>
            </div>
            </div>
      ...
      <CarouselPrevious className='bg-black hover:bg-red-600'/>
      <CarouselNext className='bg-black hover:bg-red-600'/>
    </Carousel>
